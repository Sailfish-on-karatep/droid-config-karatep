# DisplayName: Jolla karatep/@ARCH@ (release) 1
# KickstartType: release
# DeviceModel: karatep
# DeviceVariant: karatep
# Brand: Jolla
...
repo --name=adaptation-common-karatep-@RELEASE@ --baseurl=https://releases.jolla.com/releases/@RELEASE@/jolla-hw/adaptation-common/@ARCH@/
repo --name=adaptation-community-common-karatep-@RELEASE@ --baseurl=https://repo.sailfishos.org/obs/nemo:/devel:/hw:/common/sailfish_latest_@ARCH@/
...
%packages
patterns-sailfish-device-configuration-karatep
%end

%attachment
### Commands from /tmp/sandbox/usr/share/ssu/kickstart/attachment/karatep
